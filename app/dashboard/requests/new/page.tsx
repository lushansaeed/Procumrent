...
const UNITS = [
  "PCS", "KG", "LTR", "MTR", "BOX", "CARTON", "PACK", "ROLL", "SET", "PAIR", "DOZEN", "UNIT",
];
...
export default function NewRequestPage() {
  ...
  const getRowTotal = (item: RequestItem) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const invalidItem = items.find(
      (item) => !item.itemName.trim() || !item.quantity || parseFloat(item.quantity) <= 0
    );
    if (invalidItem) {
      toast.error("Please fill in all item names and valid quantities");
      return;
    }
    ...
    try {
      const payload = {
        ...
        items: items.map((item) => ({
          ...
          estimatedTotal: getRowTotal(item),
        })),
      };
          ...
          <CardContent>
            {loadingUser ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div>
                  <Label className="text-xs text-gray-500 font-medium">Reporting Manager</Label>
                  <div className="mt-1 px-3 py-2 bg-gray-50 border border-gray-200 rounded-md text-sm text-gray-700">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="requiredDate">Required By Date <span className="text-red-500">*</span></Label>
                <Input
                  id="requiredDate"
                  type="date"
                  value={requiredDate}
            ...
            <div className="space-y-1.5">
              <Label htmlFor="purpose">Purpose / Justification <span className="text-red-500">*</span></Label>
              <textarea
                id="purpose"
                ...
                rows={3}
                placeholder="Describe the business need and reason for this request..."
                value={purpose}
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b bg-gray-50">
                    ...
                    <th className="text-left px-3 py-2.5 font-medium text-gray-600 min-w-[180px]">Item Name <span className="text-red-500">*</span></th>
                    <th className="text-left px-3 py-2.5 font-medium text-gray-600 min-w-[160px]">Description</th>
                    <th className="text-left px-3 py-2.5 font-medium text-gray-600 w-24">Qty <span className="text-red-500">*</span></th>
                ...
                <tfoot>
                  <tr className="bg-gray-50">
                    ...
                    <td className="px-3 py-3 font-bold text-gray-900 text-base whitespace-nowrap">
